...
<gameSystem id="9481a749-7900-614b-1695-bdc2899069c1" name="Mordheim" revision="16" battleScribeVersion="2.03" authorName="Uncle Mel" xmlns="http://www.battlescribe.net/schema/gameSystemSchema" type="gameSystem">
  ...
  <profileTypes>
    ...
    <profileType id="9db87680-6ee5-b46c-48ca-dcd1c5de1bad" name="H-t-h Weapon">
      <characteristicTypes>
    ...
    <profileType id="94239014-ea28-23eb-4142-f492dc4caf17" name="Armour">
      <characteristicTypes>
        <characteristicType id="26f1ea4e-6017-a8fa-db2b-5c2a83aea46b" name="Armour Save"/>
